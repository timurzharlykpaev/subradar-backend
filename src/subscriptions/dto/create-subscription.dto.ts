...
import { SubscriptionCategory, BillingPeriod, SubscriptionStatus, AddedVia } from '../entities/subscription.entity';

export class CreateSubscriptionDto {
  @ApiProperty() @IsString() name: string;
  @ApiPropertyOptional({ enum: SubscriptionCategory }) @IsOptional() @IsEnum(SubscriptionCategory) category?: SubscriptionCategory;
  ...
  @ApiPropertyOptional({ enum: AddedVia }) @IsOptional() @IsEnum(AddedVia) addedVia?: AddedVia;
